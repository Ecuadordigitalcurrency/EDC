...
//#1
int64 nChainStartTime = 1481660557;
...
const string strMessageMagic = "EcuadorDigitalCurrency Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in EcuadorDigitalCurrency
    bool fStrictPayToScriptHash = true; // Always active in EcuadorDigitalCurrency
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EcuadorDigitalCurrency", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //#1
        const char* pszTimestamp = "CBigNum vector EcuadorDigitalCurrency empty mapBlockIndex EcuadorDigitalCurrency EcuadorDigitalCurrency";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        //#1
        assert(block.hashMerkleRoot == uint256("0xd67516ea43b31937b39371aaac064eac19e6b3662bb7b6e7a31e940d76969aca"));
