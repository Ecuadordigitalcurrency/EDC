TEMPLATE = app
TARGET = EcuadorDigitalCurrency-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = EcuadorDigitalCurrency-qt_test
...
macx:ICON = src/qt/res/icons/EcuadorDigitalCurrency.icns
macx:TARGET = "EcuadorDigitalCurrency-Qt"
